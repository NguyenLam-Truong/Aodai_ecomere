...
<div id="page-content">
    ...
    <h3 class="page-header page-header-top"><i class="fa fa-flag"></i> FAQ <small>An example page with questions and answers</small></h3>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <ul id="faq-tabs" class="nav nav-pills nav-stacked" data-toggle="tabs">
                <li class="active"><a href="#faq1-section"><i class="fa fa-beer"></i> General</a></li>
                <li><a href="#faq2-section"><i class="fa fa-bell-o"></i> UI</a></li>
                <li><a href="#faq3-section"><i class="fa fa-book"></i> Subscriptions</a></li>
                <li><a href="#faq4-section"><i class="fa fa-umbrella"></i> Features</a></li>
                <li><a href="#faq5-section"><i class="fa fa-wrench"></i> Support</a></li>
                <li><a href="#faq6-section"><i class="fa fa-bookmark"></i> Legal Stuff</a></li>
            </ul>
            <!-- END Tab Links -->
        </div>
        <div class="col-md-9">
            ...
            <div class="tab-content tab-content-default">
                    ...
                    <div id="faq1" class="panel-group">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q1">01. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q2">02. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q3">03. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q4">04. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q5">05. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q6">06. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q7">07. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq1" href="#faq1_q8">08. Question?</a></h4>
                            </div>
                ...
                <div id="faq6-section" class="tab-pane">
                    <div id="faq6" class="panel-group">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq6" href="#faq6_q1">27. Question?</a></h4>
                            </div>
                            <div id="faq6_q1" class="panel-collapse collapse in">
                                <div class="panel-body">Donec lacinia venenatis metus at bibendum? In hac habitasse platea dictumst. Proin ac nibh rutrum lectus rhoncus eleifend. Sed porttitor pretium venenatis. Suspendisse potenti. Aliquam quis ligula elit. Aliquam at orci ac neque semper dictum. Sed tincidunt scelerisque ligula, et facilisis nulla hendrerit non. Suspendisse potenti. Pellentesque non accumsan orci. Praesent at lacinia dolor. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq6" href="#faq6_q2">28. Question?</a></h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq6" href="#faq6_q3">29. Question?</a></h4>
                            </div>
                            <div id="faq6_q3" class="panel-collapse collapse">
                                <div class="panel-body">Donec lacinia venenatis metus at bibendum? In hac habitasse platea dictumst. Proin ac nibh rutrum lectus rhoncus eleifend. Sed porttitor pretium venenatis. Suspendisse potenti. Aliquam quis ligula elit. Aliquam at orci ac neque semper dictum. Sed tincidunt scelerisque ligula, et facilisis nulla hendrerit non. Suspendisse potenti. Pellentesque non accumsan orci. Praesent at lacinia dolor. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#faq6" href="#faq6_q4">30. Question?</a></h4>
                            </div>
                            <div id="faq6_q4" class="panel-collapse collapse">
                                <div class="panel-body">Donec lacinia venenatis metus at bibendum? In hac habitasse platea dictumst. Proin ac nibh rutrum lectus rhoncus eleifend. Sed porttitor pretium venenatis. Suspendisse potenti. Aliquam quis ligula elit. Aliquam at orci ac neque semper dictum. Sed tincidunt scelerisque ligula, et facilisis nulla hendrerit non. Suspendisse potenti. Pellentesque non accumsan orci. Praesent at lacinia dolor. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
                            </div>
                        </div>
                    </div>
