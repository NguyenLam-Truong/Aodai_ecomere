<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
        ...
        <!-- Bootstrap.js -->
        <script src="../../public/view_admin/uAdmin 2.1 by pixelcave/02 - uAdmin Template (HTML)/js/vendor/bootstrap.min.js">
            js/vendor/bootstrap.min.js
        </script>

        <!-- Jquery plugins and custom javascript code -->
        <script src="../../public/view_admin/uAdmin 2.1 by pixelcave/02 - uAdmin Template (HTML)/js/plugins.js"></script>
        <script src="../../public/view_admin/uAdmin 2.1 by pixelcave/02 - uAdmin Template (HTML)/js/main.js"></script>
