...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <?php include_once ('../../inc/admin/header_admin.php'); ?>
    </head>
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <!-- Primary Navigation -->
                    <?php
                      include_once ('../../inc/admin/sidebar_admin.php');
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        ...
                        <li><a href="javascript:void(0)">MÃ LOẠI</a></li>
                        <li class="active"><a href="">SỬA MÃ LOẠI</a></li>
                    </ul>
                    <!-- END Navigation info -->

                    <!-- Form Masked, Initialization happens at the bottom of the page -->
                    <form action="?act=update" method="post" class="form-horizontal form-box remove-margin">
                        <!-- Form Header -->
                        <h4 class="form-box-header">SỬA MÃ LOẠI</h4>

                        <!-- Form Content -->
                        <?php if(!empty($data_edit)) {
                                foreach ($data_edit as $row) {    
                        ?>
                        <div class="form-box-content">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="masked_date">ID MÃ LOẠI</label>
                                <div class="col-md-6">
                                    <input type="text" id="masked_date" name="id" class="form-control">
                                    <input type="hidden" name="id_old" value="<?=$row['idmaloai']?>">
                                    <span class="help-block">MÃ LOẠI : <?=$row['idmaloai']?></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="masked_date2">TÊN MÃ LOẠI</label>
                                <div class="col-md-6">
                                    <input type="text" id="masked_date2" name="name" class="form-control">
                                    <span class="help-block">TÊN MÃ LOẠI : <?=$row['tenLoai']?></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2" for="masked_phone">NGÀY NHẬP</label>
                                <div class="col-md-6">
                                    <input type="date" id="masked_phone" name="date_fill" class="form-control">
                                    <span class="help-block">NGÀY NHẬP : <?=$row['ngaynhap']?></span>
                                </div>
                            </div>
                            <?php }
                               }
                            ...
                            <div class="form-group form-actions">
                                <div class="col-md-10 col-md-offset-2">
                                    ...
                                    <button type="submit" name="edit" class="btn btn-success"><i class="fa fa-check"></i> Submit</button>
                                </div>
                            </div>
                        </div>
                        <!-- END Form Content -->
        ...
        <?php
          include_once ('../../inc/admin/footer_admin.php');
        ?>
