...
<head>
    ...
    <?php include('../../inc/admin/header_admin.php'); ?>
</head>
    ...
    <div id="page-container">
        ...
        <div id="inner-container">
            ...
            <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                ...
                <!-- Primary Navigation -->
                <?php include('../../inc/admin/sidebar_admin.php'); ?>
            ...
            <div id="page-content">
                ...
                <ul id="nav-info" class="clearfix">
                    ...
                    <?php if (isset($title)) { ?>
                        <li><a href="#"><?php echo $title['name']; ?></a></li>
                        <li class="active"><a href="#"><?php echo $title['function']; ?></a></li>
                    <?php } ?>
                </ul>
                <!-- END Navigation info -->

                <!-- Default style -->
                <h3 class="page-header page-header-top">QUẢN LÍ LOẠI SẢN PHẨM</h3>
                <table class="table">
                    <thead>
                        <tr>
                            <th class="text-center">ID MÃ LOẠI</th>
                            <th>TÊN LOẠI</th>
                            <th>NGÀY NHẬP</th>
                            <th class="text-center"><i class="fa fa-bolt"></i>HANDLE</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td class="text-center"><?=$row['idmaloai']?></td>
                            <td><a href="javascript:void(0)"><?=$row['tenLoai']?></a></td>
                            <th><?=$row['ngaynhap']?></th>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <?php if($backPage >=1) { ?>
                            <li>
                                <a href="?act=maloai&pageNum=<?php echo $backPage ?>" aria-label="Previous">
                        ...
                        <?php for($i= $from ; $i <= $to ; $i++) { ?>
                            <li><a href="?act=maloai&pageNum=<?php echo $i?>"><?php echo $i?></a></li>
                        <?php }?>

                        <!-- nếu như tổng số trang lớn hơn -->
                        <?php if($nextPage < $totalSize) {?>
                        <li>
                            <a href="?act=maloai&pageNum=<?php echo $nextPage ?>" aria-label="Next">
        ...
        <?php include('../../inc/admin/footer_admin.php'); ?>
</body>
